> STATUS (2026-09-14): P0 DONE + deployed; P1 DONE + deployed (incl. scheduled-time pricing); P2 partly DONE. vitest 69/69. Live server-side smoke of the full journey PASSED on prod (see HANDOFF). Remaining (documented next actions): full ETA source-exposure in the passenger UI, full chat cursor pagination, notification outbox, and a real on-phone browser journey (device GPS + push).
>
> Completion matrix:
